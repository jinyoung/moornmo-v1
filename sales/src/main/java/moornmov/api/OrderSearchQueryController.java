...
@RestController
public class OrderSearchQueryController {

    private final QueryGateway queryGateway;

    private final ReactorQueryGateway reactorQueryGateway;

    public OrderSearchQueryController(
    ...
    @GetMapping("/orders")
    public CompletableFuture findAll(OrderSearchQuery query) {
        return queryGateway
            .query(
                query,
    ...
    public CompletableFuture findById(@PathVariable("id") String id) {
        OrderSearchSingleQuery query = new OrderSearchSingleQuery();
        query.setId(id);
